...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.quicksilver_train = factory();
    }
}( this, function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_1c14d0a709c5ec7f246dd5a4448110242b28bd39": function($0) {
                return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof Gamepad) | 0;
            },
            ...
            "__extjs_df8ec10d009201a5ec81f8bdd57683fac0b3502f": function($0) {
                return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof GamepadButton) | 0;
            },
            ...
            "__extjs_aa6aafdf07ae187fcd26a3b246b8260ed533d122": function($0) {
                return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof WebGL2RenderingContext) | 0;
            },
            ...
            "__extjs_8840df25a0af65ddee5d1e1d7ddbe64d9463c156": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){document.getElementById ("canvas"). onwheel = function (e){($1)(e.deltaX , e.deltaY , e.deltaMode); e.preventDefault ();}})());
            },
            ...
            "__extjs_a0b118584612ec03523e6ba37bc7e85876cef7e6": function($0) {
                return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof GamepadEvent) | 0;
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'quicksilver_train'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'quicksilver_train':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" && typeof process === "object" ) {
        ...
        const wasm_path = path.join( __dirname, "quicksilver_train.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "quicksilver_train.wasm", {credentials: "same-origin"} )
